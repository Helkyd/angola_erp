...
#			if "2630" in planoconta.name: break
		...
		if planoconta.parent_account:
			groupingcode.text = str(planoconta.parent_account[planoconta.parent_account.find('-')+1:len(planoconta.parent_account)])
...
#	return
	...
	if exists:
		...
		os.system("~/frappe/frappe-bench/apps/angola_erp/angola_erp/util/hash_ao_erp.sh")
