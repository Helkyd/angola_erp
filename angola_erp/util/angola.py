...
def get_taxa_ipc():
	...
	j= frappe.db.sql(""" select name, description, account_head, parent  from `tabSales Taxes and Charges` where description like '3421%' and parenttype ='Sales Taxes and Charges Template' """,as_dict=True)
