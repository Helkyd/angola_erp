...
@frappe.whitelist()
def get_saft_ao(doctype, timespan, company, field):
	...
	if doctype == "Sales Invoice":
		records = get_all_sales_invoice(from_date, company, field)
...
def get_all_sales_invoice(from_date, company, field):

	return frappe.db.sql("""
		select name as name, sum(debit) as value
