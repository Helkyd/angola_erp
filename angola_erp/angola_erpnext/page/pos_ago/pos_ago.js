...
frappe.pages['pos-ago'].on_page_load = function (wrapper) {
	...
	wrapper.pos = new angola_erp.pos_ago.PointOfSale(wrapper)
}

frappe.pages['pos-ago'].refresh = function (wrapper) {
...
angola_erp.pos_ago.PointOfSale = erpnext.taxes_and_totals.extend({
	...
	get_data_from_server: function (callback) {
		var me = this;
		frappe.call({
			method: "angola_erp.angola_erpnext.doctype.pos.get_pos_data",
			freeze: true,
	...
	load_data: function (load_doc) {
		...
		console.log(this.letter_head.header)
		console.log(this.letter_head.footer)
