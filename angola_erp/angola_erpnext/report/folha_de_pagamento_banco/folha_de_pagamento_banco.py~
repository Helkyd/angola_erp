...
def execute(filters=None):
	...
	for ss in salary_slips:
		...
		row = [ss.employee_name[0:ss.employee_name.find(' ')] + ' ' + ss.employee_name[ss.employee_name.rfind(' '):len(ss.employee_name)], ss.department, ss.designation, ss.bank_name, ss.bank_account_no
			]
...
def get_columns(salary_slips):
	columns = [
		...
		_("Bank Name") + ":Data:-1", _("Bank Account") + ":Data:-1"
