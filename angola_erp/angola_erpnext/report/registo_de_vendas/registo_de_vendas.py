...
def get_columns(invoice_list, additional_table_columns):
	...
	columns = [
		...
		_("Customer") + ":Link/Customer:120", _("Customer Name") + "::-1"
	]
	...
	columns +=[
		_("Customer Group") + ":Link/Customer Group:-1", _("Territory") + ":Link/Territory:-1",
		_("Receivable Account") + ":Link/Account:-1", _("Mode of Payment") + "::120",
		_("Project") +":Link/Project:-1", _("Remarks") + "::-1",
	...
	income_columns = [(account + ":Currency/currency:-1") for account in income_accounts]
	for account in tax_accounts:
		if account not in income_accounts:
			tax_columns.append(account + ":Currency/currency:-1")
			
	columns = columns + income_columns + [_("Net Total") + ":Currency/currency:120"] + tax_columns + \
		[_("Total Tax") + ":Currency/currency:-1", _("Grand Total") + ":Currency/currency:120",
